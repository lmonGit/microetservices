...
<html lang="fr">
    ...
    <div id="header">
        <div class="container">
            <div class="header_wrapper">
                <div class="page_title">confirmation</div>
    ...
    <div class="breadcrumbs1_wrapper">
        <div class="container">
            <div class="breadcrumbs1"><a href="/microetservices-web/index">Accueil</a><span></span> <a href="/microetservices-web/produits">Produits</a> <span></span> <a href="/microetservices-web/confirmation">Confirmation</a> <span></span> </div>
    ...
    <div id="content">
        <div class="container">
            ...
            <div id="indexLeftColumnCommander">

<!--         
            </div>
                <div id="indexRightColumnTop">
                   
                 <div class="row">
                [La boite contient les champs des détails de la commande du client]
                </div> 
                <div>
                    [bouton envoyer]
                </div>
            ...
            <div id="indexRightColumnBottom">
                   
                 <div class="row">
                [Calcul du prix total + coût livraisons]
                </div> 
            </div>
