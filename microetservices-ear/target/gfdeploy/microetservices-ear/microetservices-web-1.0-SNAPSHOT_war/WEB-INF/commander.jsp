...
<html lang="fr">
    ...
    <div id="header">
        <div class="container">
            <div class="header_wrapper">
                <div class="page_title">commander</div>
    ...
    <div class="breadcrumbs1_wrapper">
        <div class="container">
            <div class="breadcrumbs1"><a href="/microetservices-web/index">Accueil</a><span></span> <a href="/microetservices-web/produits">Produits</a> <span></span> <a href="/microetservices-web/commander">Commander</a> <span></span> </div>
    ...
    <div id="content">
        <div class="container">
            ...
            <div id="indexLeftColumn">
                   <div><p>champs de la commande</p></div>
                
            </div>

            <div id="indexRightColumn">
                <div><p>Conditions de vente</p></div>
                <div><p>Cout de la commande</p></div>
...
<!--                votre caddie contient x éléments
                [vider le caddie]    [continuer la commande] [envoyer la commande]
                
                                            [sous-total:xxx]
                                            
                 Article                      Nom                       Prix                 Quantité
                 
                  Product image             [product name]             [prix]           1 bouton de mise à jour -->
