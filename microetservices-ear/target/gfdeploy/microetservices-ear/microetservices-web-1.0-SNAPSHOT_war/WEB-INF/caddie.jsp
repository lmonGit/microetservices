...
<html lang="fr">
    ...
    <div id="header">
        <div class="container">
            <div class="header_wrapper">
                <div class="page_title">caddie</div>
    ...
    <div class="breadcrumbs1_wrapper">
        <div class="container">
            <div class="breadcrumbs1"><a href="/microetservices-web/index">Accueil</a><span></span> <a href="/microetservices-web/produits">Produits</a> <span></span> <a href="/microetservices-web/caddie">Caddie</a> <span></span> </div>
    ...
    <div id="content">
        <div class="container">
            ...
            <div id="indexRightColumn">
                <br>
                <p>Votre charriot contient x articles</p>
                <br>
                
                <table border ="0" >
                    <tr>
                        <td>
                            <a href="/microetservices-web/index">Vider le charriot</a>                            
                        </td>
                        
                        <td>
                            <a href="/microetservices-web/index">Continuer la commande</a>                            
                        </td>
                        <td>
                            <a href="/microetservices-web/index">Envoyer la commande</a>      
                        </td>
                    </tr>
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="articleNumber" id="AN" /> <button type="button">Rectifier</button> </td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="articleNumber" id="" /> <button type="button">Rectifier</button> </td>
